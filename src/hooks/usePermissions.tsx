...
const ROLE_PERMISSIONS: RolePermission[] = [
  {
    ...
    permissions: {
      ...
      keywordResearch: { view: true, analyze: true, export: true },
      bulkCreation: { view: true, create: true, manage: true },
      cloudflare: { view: true, manage: true },
      analytics: { view: true },
  ...
  },
  {
    ...
    permissions: {
      ...
      domains: { view: true, create: true, edit: false, delete: false },
      keywordResearch: { view: true, analyze: true, export: false },
      bulkCreation: { view: true, create: true, manage: false },
      cloudflare: { view: true, manage: false },
      analytics: { view: true },
  ...
  },
  {
    ...
    permissions: {
      ...
      keywordResearch: { view: true, analyze: false, export: false },
      bulkCreation: { view: true, create: false, manage: false },
      cloudflare: { view: false, manage: false },
      analytics: { view: true },
      reports: { view: true, create: false },
      settings: { view: false, edit: false },
      permissions: { view: false, manage: false },
